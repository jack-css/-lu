var Fireworks = function (id_name) {
	/*=============================================================================*/
	/* Utility
	/*=============================================================================*/
	var self = this;
	...
	self.init = function () {
		...
		//console.log(self.id_name, 'dehr')
		self.canvasContainer = $(self.id_name);
		var canvasContainerDisabled = document.getElementById(id_name);
		self.canvas.onselectstart = function () {
			return false;
		};

		self.canvas.width = self.cw = 600;
		self.canvas.height = self.ch = 780;
	...
	while (initialLaunchCount--) {
		...
		}, initialLaunchCount * 600);
	}

}
var id_name1 = "canvas-container";
var fworks = new Fireworks(id_name1);
var id_name2 = "rightcv";
var fworks = new Fireworks(id_name2);
var gui = new dat.GUI({
	autoPlace: false,
	load: guiPresets,
	preset: 'Default'
